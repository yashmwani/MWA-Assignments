	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To SYKU Servlet Project</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Tried For the first time</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">I am a junior in Computer Science Engineering at JSPM's RSCOE Pune. 
					I am accredited with multiple certifications from Cisco Networking Academy and Coursera
					(Details available upon request). 
					I have moderate knowledge about Computer programming languages like C, C++, Python and Java.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">I am interested to work in the field of Artificial intelligence and Machine learning, 
					and hence i am looking for an internship which will help me explore these fields and provide me with 
					the required skill sets for the professional market.</p>
				</div>
			</div>
			<!-- About Section Button-->
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href="https://www.youtube.com/watch?v=tgB1wUcmbbw"> <i
					class="fas fa-play"></i> Free Watch!
				</a>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<a class="btn btn-outline-light btn-social mx-1" href="https://www.facebook.com/profile.php?id=100008854938901"><i
						class="fab fa-fw fa-facebook-f"></i></a> <a
						class="btn btn-outline-light btn-social mx-1" href="https://twitter.com/YashWan23326834"><i
						class="fab fa-fw fa-twitter"></i></a> <a
						class="btn btn-outline-light btn-social mx-1" href="https://www.linkedin.com/in/yash-wani-13a1031b6/"><i
						class="fab fa-fw fa-linkedin-in"></i></a> <a
						class="btn btn-outline-light btn-social mx-1" href="https://www.instagram.com/yashmwani_2001/"><i
						class="fab fa-fw fa-instagram"></i></a>
				</div>
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">Real Fact about this project</h4>
					<p class="lead mb-0">
						This is done with the help of online video from Unique Developer
					</p>
				</div>
			</div>
		</div>
